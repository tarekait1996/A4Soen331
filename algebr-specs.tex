...
\hspace*{5mm} [A5] size (addlocation(addLocation(map, newLocation(d,q)), newLocation(d,p))) = size(map)\\
\hspace*{5mm} [A6] isempty(deleteLocation(addlocation(newmap, newlocation(d,p)), d)) = true \\
\hspace*{5mm} [A7] findlocation(addlocation(newmap, newlocation(d,p)), d) = p\\
