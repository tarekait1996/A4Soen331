...
\hspace*{5mm} [A2] isempty(addlocation(newmap, loc)) = false;\\
\hspace*{5mm} [A3] isempty(clear(map)) = true;\\
\hspace*{5mm} [A4] \\
\hspace*{5mm} [A5] \\
\hspace*{5mm} [A6] \\
\hspace*{5mm} [A7] \\
\hspace*{5mm} [A8] \\
\hspace*{5mm} [A9] findlocation(newmap) = undefined;\\
\hspace*{5mm} [A10] deletelocation(newmap) = undefined;\\
